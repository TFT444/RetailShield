...
| ✅ Done | Persistence | T1078 | Valid Accounts | `after_hours_access.kql` | Medium | `notify_soc` |
...
| 🔲 Planned | Impact | T1486 | Data Encrypted for Impact | `ransomware_indicator.kql` | Critical | `isolate_endpoint` |
